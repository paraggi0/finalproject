...
public class SecondProcessActivity extends AppCompatActivity {
    ...
    private void setupToolbar() {
        ...
        getSupportActionBar().setTitle("Second Process (Assy)");
    ...
    private void setupClickListeners() {
        ...
        btnSubmit.setOnClickListener(v -> submitSecondProcess());
    }
    ...
    private void loadCustomerData() {
        ...
        apiService.getBomDropdown(new ApiService.ApiCallback() {
            ...
            public void onError(String message) {
                runOnUiThread(() -> {
                    Toast.makeText(SecondProcessActivity.this, "Error loading customer: " + message, Toast.LENGTH_SHORT).show();
                });
            }
        });
    }
    ...
    private void loadDescriptionByCustomer(String customer) {
        ...
        apiService.getBomByCustomer(customer, new ApiService.ApiCallback() {
            ...
            public void onError(String message) {
                runOnUiThread(() -> {
                    Toast.makeText(SecondProcessActivity.this, "Error loading description: " + message, Toast.LENGTH_SHORT).show();
                });
            }
        });
    }
    ...
    private void submitSecondProcess() {
        ...
        // POST data ke backend untuk WIP Second process
        apiService.submitWipSecond(partnumber, "LOT-AUTO", quantityOK, (quantityOK - quantityNG), 
                                 "ASSY", operator, description, new ApiService.ApiCallback() {
            @Override
            public void onSuccess(String responseBody) {
                runOnUiThread(() -> {
                    btnSubmit.setEnabled(true);
                    btnSubmit.setText("Submit");
                    Toast.makeText(SecondProcessActivity.this, "Data Second Process berhasil disimpan", Toast.LENGTH_SHORT).show();
                    clearForm();
                });
            }
            ...
            public void onError(String message) {
                runOnUiThread(() -> {
                    btnSubmit.setEnabled(true);
                    btnSubmit.setText("Submit");
                    Toast.makeText(SecondProcessActivity.this, "Error: " + message, Toast.LENGTH_SHORT).show();
                });
            }
        });
    }
